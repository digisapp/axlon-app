            ...
            <div className="flex gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="inline-flex items-center justify-center p-3 rounded-lg bg-muted hover:bg-muted/80 text-muted-foreground hover:text-foreground transition-colors"

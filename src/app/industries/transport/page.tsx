    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/search?category=lowboy-trailers">Browse Trailers</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          From lead capture to fleet analytics, Axleyard gives heavy haul companies the AI edge.
        </p>
      ...
      <section className="bg-muted/30 border-y">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          <h2 className="text-3xl font-bold mb-4">How transport companies use Axleyard</h2>

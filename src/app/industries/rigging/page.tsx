...
export const metadata: Metadata = {
  title: 'AI Tools for Rigging & Heavy Lift Services | AxlonAI',
  description: 'AxlonAI helps rigging companies, millwrights, and heavy lift service providers manage leads, list equipment, and grow with AI-powered tools.',
  openGraph: {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          From lead capture to project tracking, AxlonAI gives rigging and heavy lift companies the AI tools to win more work.
        </p>
      ...
      <section className="bg-muted/30 border-y">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          <h2 className="text-3xl font-bold mb-4">How rigging companies use AxlonAI</h2>

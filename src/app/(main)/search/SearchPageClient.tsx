  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        ...
        {/* Quick Filter Chips */}
        <div className="flex flex-nowrap gap-1.5 sm:gap-2 mb-4 md:mb-6 overflow-x-auto snap-x [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:flex-wrap md:overflow-visible pb-2 sm:pb-1">
          <QuickFilterChip
            label="Under $50K"
          ...
          <div className="w-px h-6 bg-border self-center hidden sm:block flex-shrink-0" />
          ...
          {activeFilterCount > 0 && (
            <button
              ...
              className="px-3 py-2 md:py-1.5 text-sm rounded-full border border-destructive/50 text-destructive hover:bg-destructive/10 transition-colors flex items-center gap-1.5 flex-shrink-0 snap-start whitespace-nowrap"
            >
              Clear All
            </button>
          )}
